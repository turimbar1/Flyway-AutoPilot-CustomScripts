...
GO
IF OBJECT_ID(N'[Sales].[Customers]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[PK_Customers]', 'PK') AND parent_object_id = OBJECT_ID(N'[Sales].[Customers]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'City' AND object_id = OBJECT_ID(N'[Sales].[Customers]'))
CREATE NONCLUSTERED INDEX [City] ON [Sales].[Customers] ([City])
GO
PRINT N'Creating index [CompanyName] on [Sales].[Customers]'
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'CompanyName' AND object_id = OBJECT_ID(N'[Sales].[Customers]'))
CREATE NONCLUSTERED INDEX [CompanyName] ON [Sales].[Customers] ([CompanyName])
GO
PRINT N'Creating index [PostalCode] on [Sales].[Customers]'
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PostalCode' AND object_id = OBJECT_ID(N'[Sales].[Customers]'))
CREATE NONCLUSTERED INDEX [PostalCode] ON [Sales].[Customers] ([PostalCode])
GO
PRINT N'Creating index [Region] on [Sales].[Customers]'
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'Region' AND object_id = OBJECT_ID(N'[Sales].[Customers]'))
CREATE NONCLUSTERED INDEX [Region] ON [Sales].[Customers] ([Region])
GO
PRINT N'Creating [Sales].[CustomersFeedback]'
GO
IF OBJECT_ID(N'[Sales].[CustomersFeedback]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[PK__Customer__6A4BEDF61A949274]', 'PK') AND parent_object_id = OBJECT_ID(N'[Sales].[CustomersFeedback]', 'U'))
...
GO
IF OBJECT_ID(N'[Logistics].[Flight]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Logistics].[PK__Flight__8A9E148E9A8ED149]', 'PK') AND parent_object_id = OBJECT_ID(N'[Logistics].[Flight]', 'U'))
...
GO
IF OBJECT_ID(N'[Logistics].[MaintenanceLog]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Logistics].[PK__Maintena__5E5499A8A7E7CD24]', 'PK') AND parent_object_id = OBJECT_ID(N'[Logistics].[MaintenanceLog]', 'U'))
ALTER TABLE [Logistics].[MaintenanceLog] ADD CONSTRAINT [PK__Maintena__5E5499A8A7E7CD24] PRIMARY KEY CLUSTERED ([LogID])
GO
PRINT N'Creating [Sales].[Orders]'
GO
IF OBJECT_ID(N'[Sales].[Orders]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[PK_Orders]', 'PK') AND parent_object_id = OBJECT_ID(N'[Sales].[Orders]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'CustomerID' AND object_id = OBJECT_ID(N'[Sales].[Orders]'))
CREATE NONCLUSTERED INDEX [CustomerID] ON [Sales].[Orders] ([CustomerID])
GO
PRINT N'Creating index [CustomersOrders] on [Sales].[Orders]'
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'CustomersOrders' AND object_id = OBJECT_ID(N'[Sales].[Orders]'))
CREATE NONCLUSTERED INDEX [CustomersOrders] ON [Sales].[Orders] ([CustomerID])
GO
PRINT N'Creating index [EmployeeID] on [Sales].[Orders]'
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'EmployeeID' AND object_id = OBJECT_ID(N'[Sales].[Orders]'))
CREATE NONCLUSTERED INDEX [EmployeeID] ON [Sales].[Orders] ([EmployeeID])
GO
PRINT N'Creating index [EmployeesOrders] on [Sales].[Orders]'
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'EmployeesOrders' AND object_id = OBJECT_ID(N'[Sales].[Orders]'))
CREATE NONCLUSTERED INDEX [EmployeesOrders] ON [Sales].[Orders] ([EmployeeID])
GO
PRINT N'Creating index [OrderDate] on [Sales].[Orders]'
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'OrderDate' AND object_id = OBJECT_ID(N'[Sales].[Orders]'))
CREATE NONCLUSTERED INDEX [OrderDate] ON [Sales].[Orders] ([OrderDate])
GO
PRINT N'Creating index [ShippedDate] on [Sales].[Orders]'
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'ShippedDate' AND object_id = OBJECT_ID(N'[Sales].[Orders]'))
CREATE NONCLUSTERED INDEX [ShippedDate] ON [Sales].[Orders] ([ShippedDate])
GO
PRINT N'Creating index [ShipPostalCode] on [Sales].[Orders]'
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'ShipPostalCode' AND object_id = OBJECT_ID(N'[Sales].[Orders]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'ShippersOrders' AND object_id = OBJECT_ID(N'[Sales].[Orders]'))
CREATE NONCLUSTERED INDEX [ShippersOrders] ON [Sales].[Orders] ([ShipVia])
GO
PRINT N'Creating [Sales].[OrderAuditLog]'
GO
IF OBJECT_ID(N'[Sales].[OrderAuditLog]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[PK__OrderAud__A17F23B8298306B2]', 'PK') AND parent_object_id = OBJECT_ID(N'[Sales].[OrderAuditLog]', 'U'))
...
GO
IF OBJECT_ID(N'[Operation].[Employees]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Operation].[PK_Employees]', 'PK') AND parent_object_id = OBJECT_ID(N'[Operation].[Employees]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'LastName' AND object_id = OBJECT_ID(N'[Operation].[Employees]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PostalCode' AND object_id = OBJECT_ID(N'[Operation].[Employees]'))
CREATE NONCLUSTERED INDEX [PostalCode] ON [Operation].[Employees] ([PostalCode])
GO
PRINT N'Creating [Logistics].[EmployeeTerritories]'
GO
IF OBJECT_ID(N'[Logistics].[EmployeeTerritories]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Logistics].[PK_EmployeeTerritories]', 'PK') AND parent_object_id = OBJECT_ID(N'[Logistics].[EmployeeTerritories]', 'U'))
...
GO
IF OBJECT_ID(N'[Sales].[Territories]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[PK_Territories]', 'PK') AND parent_object_id = OBJECT_ID(N'[Sales].[Territories]', 'U'))
...
GO
IF OBJECT_ID(N'[Sales].[Order Details]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[PK_Order_Details]', 'PK') AND parent_object_id = OBJECT_ID(N'[Sales].[Order Details]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'OrderID' AND object_id = OBJECT_ID(N'[Sales].[Order Details]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'OrdersOrder_Details' AND object_id = OBJECT_ID(N'[Sales].[Order Details]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'ProductID' AND object_id = OBJECT_ID(N'[Sales].[Order Details]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'ProductsOrder_Details' AND object_id = OBJECT_ID(N'[Sales].[Order Details]'))
CREATE NONCLUSTERED INDEX [ProductsOrder_Details] ON [Sales].[Order Details] ([ProductID])
GO
PRINT N'Creating [Operation].[Products]'
GO
IF OBJECT_ID(N'[Operation].[Products]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Operation].[PK_Products]', 'PK') AND parent_object_id = OBJECT_ID(N'[Operation].[Products]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'CategoriesProducts' AND object_id = OBJECT_ID(N'[Operation].[Products]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'CategoryID' AND object_id = OBJECT_ID(N'[Operation].[Products]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'ProductName' AND object_id = OBJECT_ID(N'[Operation].[Products]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'SupplierID' AND object_id = OBJECT_ID(N'[Operation].[Products]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'SuppliersProducts' AND object_id = OBJECT_ID(N'[Operation].[Products]'))
CREATE NONCLUSTERED INDEX [SuppliersProducts] ON [Operation].[Products] ([SupplierID])
GO
PRINT N'Creating [Logistics].[Shippers]'
GO
IF OBJECT_ID(N'[Logistics].[Shippers]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Logistics].[PK_Shippers]', 'PK') AND parent_object_id = OBJECT_ID(N'[Logistics].[Shippers]', 'U'))
...
GO
IF OBJECT_ID(N'[Operation].[Categories]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Operation].[PK_Categories]', 'PK') AND parent_object_id = OBJECT_ID(N'[Operation].[Categories]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'CategoryName' AND object_id = OBJECT_ID(N'[Operation].[Categories]'))
CREATE NONCLUSTERED INDEX [CategoryName] ON [Operation].[Categories] ([CategoryName])
GO
PRINT N'Creating [Logistics].[Suppliers]'
GO
IF OBJECT_ID(N'[Logistics].[Suppliers]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Logistics].[PK_Suppliers]', 'PK') AND parent_object_id = OBJECT_ID(N'[Logistics].[Suppliers]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'CompanyName' AND object_id = OBJECT_ID(N'[Logistics].[Suppliers]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PostalCode' AND object_id = OBJECT_ID(N'[Logistics].[Suppliers]'))
CREATE NONCLUSTERED INDEX [PostalCode] ON [Logistics].[Suppliers] ([PostalCode])
GO
PRINT N'Creating [Logistics].[Region]'
GO
IF OBJECT_ID(N'[Logistics].[Region]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Logistics].[PK_Region]', 'PK') AND parent_object_id = OBJECT_ID(N'[Logistics].[Region]', 'U'))
...
GO
IF OBJECT_ID(N'[Sales].[CustomerOrdersView]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW [Sales].[CustomerOrdersView]
AS
...
GO
IF OBJECT_ID(N'[Sales].[CustomersFeedbackSummary]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW [Sales].[CustomersFeedbackSummary]
AS
...
GO
IF OBJECT_ID(N'[Logistics].[FlightMaintenanceStatus]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW [Logistics].[FlightMaintenanceStatus]
AS
...
GO
IF OBJECT_ID(N'[Logistics].[UpdateAvailableSeats]', 'P') IS NULL
EXEC sp_executesql N'CREATE PROCEDURE [Logistics].[UpdateAvailableSeats] @FlightID INT, @SeatChange INT
AS BEGIN
...
GO
IF OBJECT_ID(N'[Logistics].[AddMaintenanceLog]', 'P') IS NULL
EXEC sp_executesql N'CREATE PROCEDURE [Logistics].[AddMaintenanceLog] @FlightID INT, @Description NVARCHAR(500)
AS BEGIN
...
GO
IF OBJECT_ID(N'[Customers].[RecordFeedback]', 'P') IS NULL
EXEC sp_executesql N'CREATE PROCEDURE [Customers].[RecordFeedback] @CustomerID INT, @Rating INT, @Comments NVARCHAR(500)
AS BEGIN
...
GO
IF OBJECT_ID(N'[Sales].[Order Details Extended]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW [Sales].[Order Details Extended]
AS
...
GO
IF OBJECT_ID(N'[Sales].[Order Subtotals]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW [Sales].[Order Subtotals]
AS
...
GO
IF OBJECT_ID(N'[Sales].[Sales by Category]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW [Sales].[Sales by Category]
AS
...
GO
IF OBJECT_ID(N'[Sales].[Sales Totals by Amount]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW [Sales].[Sales Totals by Amount]
AS
...
GO
IF OBJECT_ID(N'[Sales].[Summary of Sales by Quarter]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW [Sales].[Summary of Sales by Quarter]
AS
...
GO
IF OBJECT_ID(N'[Sales].[Sales by Year]', 'P') IS NULL
EXEC sp_executesql N'CREATE PROCEDURE [Sales].[Sales by Year] @Beginning_Date DATETIME, @Ending_Date DATETIME
AS
...
GO
IF OBJECT_ID(N'[Sales].[SalesByCategory]', 'P') IS NULL
EXEC sp_executesql N'CREATE PROCEDURE [Sales].[SalesByCategory] @CategoryName NVARCHAR(15), @OrdYear NVARCHAR(4) =''1998''
AS
...
GO
IF OBJECT_ID(N'[Sales].[DiscountCode]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[PK__Discount__E43F6DF6CA2BF14E]', 'PK') AND parent_object_id = OBJECT_ID(N'[Sales].[DiscountCode]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[UQ__Discount__A25C5AA70A86FB88]', 'UQ') AND parent_object_id = OBJECT_ID(N'[Sales].[DiscountCode]', 'U'))
...
GO
IF OBJECT_ID(N'[Logistics].[FlightRoute]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Logistics].[PK__FlightRo__80979AADC83FDFDB]', 'PK') AND parent_object_id = OBJECT_ID(N'[Logistics].[FlightRoute]', 'U'))
...
GO
IF OBJECT_ID(N'[Sales].[CustomerDemographics]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[PK_CustomerDemographics]', 'PK') AND parent_object_id = OBJECT_ID(N'[Sales].[CustomerDemographics]', 'U'))
...
GO
IF OBJECT_ID(N'[Sales].[LoyaltyProgram]', 'U') IS NULL
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[PK__LoyaltyP__7525603848DEBC46]', 'PK') AND parent_object_id = OBJECT_ID(N'[Sales].[LoyaltyProgram]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE object_id = OBJECT_ID(N'[Operation].[CK_Birthdate]', 'C') AND parent_object_id = OBJECT_ID(N'[Operation].[Employees]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE object_id = OBJECT_ID(N'[Operation].[CK_Products_UnitPrice]', 'C') AND parent_object_id = OBJECT_ID(N'[Operation].[Products]', 'U'))
ALTER TABLE [Operation].[Products] ADD CONSTRAINT [CK_Products_UnitPrice] CHECK (([UnitPrice]>=(0)))
GO
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE object_id = OBJECT_ID(N'[Operation].[CK_UnitsInStock]', 'C') AND parent_object_id = OBJECT_ID(N'[Operation].[Products]', 'U'))
ALTER TABLE [Operation].[Products] ADD CONSTRAINT [CK_UnitsInStock] CHECK (([UnitsInStock]>=(0)))
GO
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE object_id = OBJECT_ID(N'[Operation].[CK_UnitsOnOrder]', 'C') AND parent_object_id = OBJECT_ID(N'[Operation].[Products]', 'U'))
ALTER TABLE [Operation].[Products] ADD CONSTRAINT [CK_UnitsOnOrder] CHECK (([UnitsOnOrder]>=(0)))
GO
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE object_id = OBJECT_ID(N'[Operation].[CK_ReorderLevel]', 'C') AND parent_object_id = OBJECT_ID(N'[Operation].[Products]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE object_id = OBJECT_ID(N'[Sales].[CK__Customers__Ratin__2A4B4B5E]', 'C') AND parent_object_id = OBJECT_ID(N'[Sales].[CustomersFeedback]', 'U'))
ALTER TABLE [Sales].[CustomersFeedback] ADD CONSTRAINT [CK__Customers__Ratin__2A4B4B5E] CHECK (([Rating]>=(1) AND [Rating]<=(5)))
GO
PRINT N'Adding constraints to [Sales].[DiscountCode]'
GO
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE object_id = OBJECT_ID(N'[Sales].[CK__DiscountC__Disco__36B12243]', 'C') AND parent_object_id = OBJECT_ID(N'[Sales].[DiscountCode]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE object_id = OBJECT_ID(N'[Sales].[CK_UnitPrice]', 'C') AND parent_object_id = OBJECT_ID(N'[Sales].[Order Details]', 'U'))
ALTER TABLE [Sales].[Order Details] ADD CONSTRAINT [CK_UnitPrice] CHECK (([UnitPrice]>=(0)))
GO
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE object_id = OBJECT_ID(N'[Sales].[CK_Quantity]', 'C') AND parent_object_id = OBJECT_ID(N'[Sales].[Order Details]', 'U'))
ALTER TABLE [Sales].[Order Details] ADD CONSTRAINT [CK_Quantity] CHECK (([Quantity]>(0)))
GO
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE object_id = OBJECT_ID(N'[Sales].[CK_Discount]', 'C') AND parent_object_id = OBJECT_ID(N'[Sales].[Order Details]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Logistics].[FK_EmployeeTerritories_Employees]','F') AND parent_object_id = OBJECT_ID(N'[Logistics].[EmployeeTerritories]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Logistics].[FK_EmployeeTerritories_Territories]','F') AND parent_object_id = OBJECT_ID(N'[Logistics].[EmployeeTerritories]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Operation].[FK_Employees_Employees]','F') AND parent_object_id = OBJECT_ID(N'[Operation].[Employees]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Operation].[FK_Products_Categories]','F') AND parent_object_id = OBJECT_ID(N'[Operation].[Products]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Operation].[FK_Products_Suppliers]','F') AND parent_object_id = OBJECT_ID(N'[Operation].[Products]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK__Customers__Custo__286302EC]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[CustomersFeedback]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK_Order_Details_Orders]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[Order Details]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK_Order_Details_Products]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[Order Details]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK__OrderAudi__Order__4316F928]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[OrderAuditLog]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK_Orders_Customers]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[Orders]', 'U'))
ALTER TABLE [Sales].[Orders] ADD CONSTRAINT [FK_Orders_Customers] FOREIGN KEY ([CustomerID]) REFERENCES [Sales].[Customers] ([CustomerID])
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK_Orders_Employees]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[Orders]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK_Orders_Shippers]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[Orders]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK_Territories_Region]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[Territories]', 'U'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Logistics].[FK__Maintenan__Fligh__30F848ED]','F') AND parent_object_id = OBJECT_ID(N'[Logistics].[MaintenanceLog]', 'U'))
...
GO
IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Logistics].[FK_EmployeeTerritories_Employees]','F') AND parent_object_id = OBJECT_ID(N'[Logistics].[EmployeeTerritories]', 'U'))
ALTER TABLE [Logistics].[EmployeeTerritories] NOCHECK CONSTRAINT [FK_EmployeeTerritories_Employees]
GO
IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Logistics].[FK_EmployeeTerritories_Territories]','F') AND parent_object_id = OBJECT_ID(N'[Logistics].[EmployeeTerritories]', 'U'))
...
GO
IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Operation].[FK_Employees_Employees]','F') AND parent_object_id = OBJECT_ID(N'[Operation].[Employees]', 'U'))
...
GO
IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Operation].[FK_Products_Categories]','F') AND parent_object_id = OBJECT_ID(N'[Operation].[Products]', 'U'))
ALTER TABLE [Operation].[Products] NOCHECK CONSTRAINT [FK_Products_Categories]
GO
IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Operation].[FK_Products_Suppliers]','F') AND parent_object_id = OBJECT_ID(N'[Operation].[Products]', 'U'))
...
GO
IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK__Customers__Custo__286302EC]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[CustomersFeedback]', 'U'))
...
GO
IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK_Order_Details_Orders]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[Order Details]', 'U'))
ALTER TABLE [Sales].[Order Details] NOCHECK CONSTRAINT [FK_Order_Details_Orders]
GO
IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK_Order_Details_Products]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[Order Details]', 'U'))
...
GO
IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK__OrderAudi__Order__4316F928]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[OrderAuditLog]', 'U'))
...
GO
IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK_Orders_Customers]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[Orders]', 'U'))
ALTER TABLE [Sales].[Orders] NOCHECK CONSTRAINT [FK_Orders_Customers]
GO
IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK_Orders_Employees]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[Orders]', 'U'))
ALTER TABLE [Sales].[Orders] NOCHECK CONSTRAINT [FK_Orders_Employees]
GO
IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK_Orders_Shippers]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[Orders]', 'U'))
ALTER TABLE [Sales].[Orders] NOCHECK CONSTRAINT [FK_Orders_Shippers]
GO
PRINT N'Disabling constraints on [Sales].[Territories]'
GO
IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[Sales].[FK_Territories_Region]','F') AND parent_object_id = OBJECT_ID(N'[Sales].[Territories]', 'U'))
